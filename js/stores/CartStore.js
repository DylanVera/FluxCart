...
function removeOne(sku, update){
  update.sku = sku
  if(_products[sku].quantity - 1 > 0)
  {
    update.quantity = _products[sku].quantity - 1;
    _products[sku] = _.extend({}, _products[sku], update)
  }
  else
  {
...
AppDispatcher.register(function (payload) {
  ...
  switch (action.actionType) {
    ...
    case FluxCartConstants.CART_REMOVE:
     ...
     case FluxCartConstants.CART_REMOVE_ONE:
      removeOne(action.sku, action.update);
      break;
      
    
    case FluxCartConstants.CART_CLEAR:
      clearCart()
      break;
